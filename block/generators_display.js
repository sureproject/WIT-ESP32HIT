...
module.exports = function(Blockly) {
  "use strict";
  Blockly.JavaScript["Myi2c128x64_create_image"] = function(block) {
  ...
  Blockly.JavaScript["Myi2c128x64_display_image"] = function(block) {
  ...
  Blockly.JavaScript["Myi2c128x64_display_clear"] = function(block) {
    var code = "display.clear();\n";
    return code;
  };

  Blockly.JavaScript["Myi2c128x64_display_display"] = function(block) {
    var code = "display.display();\n";
    return code;
  };

  Blockly.JavaScript["Myi2c128x64_display_print"] = function(block) {
...
`;
  ...
  Blockly.JavaScript["Myi2c128x64_display_print_display"] = function(block) {
    var value_text = Blockly.JavaScript.valueToCode(block,
      "text",
      Blockly.JavaScript.ORDER_ATOMIC);
    var value_x = Blockly.JavaScript.valueToCode(block,
...
Blockly.JavaScript['Myi2c128x64_display_print_number_display'] = function(block) {
...
Blockly.JavaScript['Myi2c128x64_display_print_scroll_left'] = function(block) {
  ...
  var code = 
`
int strW = -(display.getStringWidth(${value_text}));
int scrW = display.getWidth();
for (int ix = scrW; ix >= strW; ix -= ${value_x}) {
	display.clear();
	display.setFont(${dropdown_font});
	display.drawString( ix,${value_y},${value_text});
	display.display();
	delay(100);
}
`;
...
Blockly.JavaScript["Myi2c128x64_display_print_display_center_one"] = function(block) {
    var value_text = Blockly.JavaScript.valueToCode(block,
      "text",
      Blockly.JavaScript.ORDER_ATOMIC);
    var dropdown_font = block.getFieldValue("font");
    ...
    var code =
      `
display.setFont(${dropdown_font});
display.drawString(((display.getWidth() - display.getStringWidth(${value_text}))/2), ((display.getHeight() - ${h})/2) ,${value_text});
`;
    return code;
  };

  Blockly.JavaScript["Myi2c128x64_display_print_display_center"] = function(block) {
    var value_text = Blockly.JavaScript.valueToCode(block,
      "text",
      Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,
    ...
    var code =
      `
display.setFont(${dropdown_font});
display.drawString(((display.getWidth() - display.getStringWidth(${value_text}))/2),${value_y},${value_text});
`;
    return code;
  };

Blockly.JavaScript['Myi2c128x64_display_print_number'] = function(block) {
  var value_text = Blockly.JavaScript.valueToCode(block, 'number', Blockly.JavaScript.ORDER_ATOMIC);
  var value_x = Blockly.JavaScript.valueToCode(block, 'x', Blockly.JavaScript.ORDER_ATOMIC);
  var value_y = Blockly.JavaScript.valueToCode(block, 'y', Blockly.JavaScript.ORDER_ATOMIC);
  var dropdown_font = block.getFieldValue('font');  
...
`;
  ...
  Blockly.JavaScript["Myi2c128x64_display_draw_line"] = function(block) {
  ...
  Blockly.JavaScript["Myi2c128x64_display_draw_rect"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,
      "x",
      Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,
  ...
  Blockly.JavaScript["Myi2c128x64_display_draw_circle"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,
      "x",
      Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,
  ...
  Blockly.JavaScript["Myi2c128x64_display_draw_progress_bar"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,
      "x",
      Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,
  ...
  Blockly.JavaScript["Myi2c128x64_display_draw_pixel"] = function(block) {
    var value_x = Blockly.JavaScript.valueToCode(block,
      "x",
      Blockly.JavaScript.ORDER_ATOMIC);
    var value_y = Blockly.JavaScript.valueToCode(block,
...
`;
  ...
  Blockly.JavaScript["Myi2c128x64_display_string_width"] = function(block) {
    var value_text = Blockly.JavaScript.valueToCode(block,
      "text",
      Blockly.JavaScript.ORDER_ATOMIC);
  ...
  Blockly.JavaScript["Myi2c128x64_display_width"] = function(block) {
    var code = "display.getWidth()";
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };

  Blockly.JavaScript["Myi2c128x64_display_height"] = function(block) {
