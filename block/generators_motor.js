...
Blockly.JavaScript['WIT_motor_forward'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
...
Blockly.JavaScript['WIT_motor_backward'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
...
Blockly.JavaScript['WIT_motor_stop_ch'] = function(block) {
  var dropdown_ch = block.getFieldValue('ch');
